                                ...
                                if uid.user_id == each.user_id:
                                    ...
                                    if get_user_id:
                                        ...
                                        if duplicate_atten_ids:
                                            ...
                                            attendance_date=fields.Date.from_string(attendance_date).strftime('%Y-%m-%d')

                                            no_checkout = self.env['hr.attendance'].search([('employee_id','=',get_user_id.id),('check_in', '>=', attendance_date),
                                                 ('check_out', '=', False)],limit=1)

                                            attendance_records = self.env['hr.attendance'].search(
                                                [('employee_id','=',get_user_id.id),('check_in', '>=', attendance_date + ' 00:00:00'),
